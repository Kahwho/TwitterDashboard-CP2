# Read the CSV file
CleanTweets <- read.csv("C:/Users/user/Desktop/Capstone 2/Codes for Tweets/Test2/TestData.csv")
...
write.csv(CleanTweets, "C:/Users/user/Desktop/Capstone 2/Codes for Tweets/Test2/Cleaned_Tweets_1.csv", row.names = FALSE)
...
writeLines(c(
  ...
  '',
  'write.csv(CleanTweets, "C:/Users/user/Desktop/Capstone 2/Codes for Tweets/Test2/Cleaned_Tweets_1.csv", row.names = FALSE)'
), con = "C:/Users/user/Desktop/Capstone 2/Codes for Tweets/Test2/clean_data_script.R")
