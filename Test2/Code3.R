...
write.csv(tweet_tokens, "C:/Users/user/Desktop/Capstone 2/Codes for Tweets/Test2/Tweet_Tokens_Cleaned.csv", row.names = FALSE)

# Save the long format data to a new CSV file
write.csv(CleanTweets_long, "C:/Users/user/Desktop/Capstone 2/Codes for Tweets/Test2/Cleaned_Tweets_Long.csv", row.names = FALSE)
...
writeLines(c(
  ...
  '',
  'write.csv(CleanTweets_long, "C:/Users/user/Desktop/Capstone 2/Codes for Tweets/Test2/Cleaned_Tweets_Long.csv", row.names = FALSE)'
), con = "C:/Users/user/Desktop/Capstone 2/Codes for Tweets/Test2/prepare_data_script.R")
