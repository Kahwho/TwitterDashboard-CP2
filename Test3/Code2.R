...
write.csv(tweet_tokens, "C:/Users/user/Desktop/Capstone 2/Codes for Tweets/Test3/Tweet_Tokens.csv", row.names = FALSE)
...
writeLines(c(
  ...
  '',
  'write.csv(tweet_tokens, "C:/Users/user/Desktop/Capstone 2/Codes for Tweets/Test3/Tweet_Tokens.csv", row.names = FALSE)'
), con = "C:/Users/user/Desktop/Capstone 2/Codes for Tweets/Test3/prepare_data_script.R")
